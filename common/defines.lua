...
NGame = {
	...
	MERC_COMPANIES_PER_RNW_REGION = 10, 		-- auto-generated merc companies per region in RNW
	...
	RNW_MERC_COMPANY_DEV_FACTOR_MAX = 0.25, 	-- max regiments_per_development
	RNW_MERC_COMPANY_CAVALRY_MIN = 0.0, 	-- min cavalry_weight if we're using cavalry
	RNW_MERC_COMPANY_CAVALRY_MAX = 0.8, 	-- max cavalry_weight if we're using cavalry
...
NDiplomacy = {
	...
	SHAREMAP_PRESTIGE_TRANSFER_LOSE = -5,				-- Prestige transferred for the Request to Share Maps diplomatic action.
	...
	HRE_PRINCE_AUTHORITY_THRESHOLD = 30,			-- Threshold below which you lose IA, and above which you gain it
	...
	GREAT_POWER_SUBJECT_CONTRIBUTION = 0.1,			-- Share of subjects' development that will count towards overlord's Great Power score.
...
NCountry = {
	...
	ESTATE_DEFAULT_LOYALTY = 50,
	ESTATE_INFLUENCE_PER_DEV = 0.5,
	ESTATE_MAX_INFLUENCE_FROM_DEV = 100.0,
	ESTATE_MIN_DISTRIBUTED_CROWNLAND = 10.5, 	-- Minimum of crownland when distributing land at start
	ESTATE_CROWNLAND_INFLUENCE = 60.0,			-- Crownland has n% influence, this is modified by absolutism.
	ESTATE_START_CROWNLAND_INFLUENCE = 1,	-- Crownland has n% influence at start of a new game.
	...
	ADVISOR_COST_INCREASE_PER_YEAR = 0.008,			-- yearly increase in price in percent,
	...
	PROMOTE_COST_MONTHS_ADVISOR_SALARY = 80.0,		-- Promote advisor cost in monthly salaries
	...
	ABANDON_IDEAGROUP_REFUND = 0.2,				-- The part of the idea group spent that will be refunded upon abandonment.
	...
	REBEL_ARTILLERY_INCREASE_LEVEL_1_SIZE = 0.3,	-- The increase in artillery as fraction of total troops given to rebels
	REBEL_ARTILLERY_INCREASE_LEVEL_2_TECH = 16,		-- Tech level at which REBEL_ARTILLERY_INCREASE_LEVEL_2_SIZE is applied
	REBEL_ARTILLERY_INCREASE_LEVEL_2_SIZE = 0.4,	-- The increase in artillery as fraction of total troops given to rebels (does not stack with level 1)
	...
	TARIFF_LIBERTY_INCREASE = 1.5,					-- Liberty increase for each % tariffs
...
NEconomy = {
	...
	GOLD_MINE_SIZE = 35,							-- Base income from gold mines
	...
	AUTONOMY_AT_DIPLO_ANNEX = 50,					-- Autonomy added when diplo-annexing
	...
	LAND_TECH_MERC_MAINTENANCE_IMPACT = 0.07, 			-- % each tech increases it.
	...
	HEAVY_SHIP_MAINT_FACTOR = 0.07,					-- _EDEF_HEAVY_SHIP_MAINT_FACTOR_
	LIGHT_SHIP_MAINT_FACTOR = 0.03,					-- _EDEF_LIGHT_SHIP_MAINT_FACTOR_
	GALLEY_MAINT_FACTOR = 0.04,						-- _EDEF_GALLEY_MAINT_FACTOR_
	TRANSPORT_MAINT_FACTOR = 0.01,					-- _EDEF_TRANSPORT_MAINT_FACTOR_
	COLONIAL_MAINTENANCE_FACTOR = 16.0,				-- _EDEF_COLONIAL_MAINTENANCE_FACTOR_
	...
	CARAVAN_FACTOR = 30.0,							-- Development is divided by this factor, do not set to zero!
...
NMilitary = {
	...
	CAWA_STARTING_MORALE = 0.3,						-- Starting morale of a cawa regiment, 1.0 being full strength
	...
	GARRISON_SIZE = 3500, 							-- GARRISON_SIZE
	...
	MERCENARY_BASE_COST = 10,					-- base cost added for a mercenary regiment
	...
	REBEL_RELOCATION_TIME = 1.0,						-- How long time it takes for rebels to relocate from island
	...
	STACKWIPE_MANPOWER_RETURN_FRACTION = 0.33,	-- Fraction of manpower that returns to pool when a stack is wiped.
...
NAI = {
	...
	AGGRESSIVENESS = 4000, -- Base chance (out of 10000) of AI being willing to start a war each diplomatic tick (~1.5 times a month)
	...
	DEFICIT_SPENDING_MIN_MONTHS = 2, -- AI must have at least this many monthly deficits of savings to be willing to deficit spend
	...
	OVER_FORCELIMIT_AVOIDANCE_FACTOR = 3, -- The higher this number is, the less willing the AI will be to exceed forcelimits
	...
	ADVISOR_BUDGET_FRACTION_MAX = 0.4, -- AI will spend a maximum of this fraction of monthly income on advisor maintenance
	...
	ARMY_BUDGET_FRACTION = 1.5, -- AI will spend a maximum of this fraction of monthly income on army maintenance (based off wartime costs)
	NAVY_BUDGET_FRACTION = 0.4, -- AI will spend a maximum of this fraction of monthly income on navy maintenance (based off wartime costs)
...
NReligion = {
	...
	CALL_ECUMENICAL_COUNCIL_COST = 50,						-- Cost in years-of-income
