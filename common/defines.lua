...
NMilitary = {
	...
	MERCENARY_REINFORCE_COST_MULTIPLIER = 0.4,			-- Mercs no longer costs anything to reinfroce
	MERCENARY_BASE_COST = 7.5,					-- base cost added for a mercenary regiment
	...
	BACK_LINE_MORALE_DAMAGE_TAKEN_MODIFIER = -0.25,	-- Multiplier for morale damage taken by backrow
